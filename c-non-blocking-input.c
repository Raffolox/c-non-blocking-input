...
/* @@@ Canonical Mode
In not-canonical mode input is available immediately, without the user having to enter a line delimiter character (e.g. \n)
Furthermore, no text manipulation on input is performed. See more: http://man7.org/linux/man-pages/man3/termios.3.html */
